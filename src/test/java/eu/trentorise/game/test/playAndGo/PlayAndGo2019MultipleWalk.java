...
public class PlayAndGo2019MultipleWalk extends GameTest {
    ...
    public void defineExecData(List<ExecData> execList) {
        ...
        ExecData input = null;
        data.put("walkDistance", 2.0);
        input = new ExecData(GAME, ACTION, "prowler", data);
        execList.add(input);
        data = new HashMap<String, Object>();
        data.put("walkDistance", 5.0);
        input = new ExecData(GAME, ACTION, "prowler", data);
        execList.add(input);
    ...
    public void analyzeResult() {
        assertionPoint(GAME, 30.0, "prowler", "green leaves");
