...
public class PedibusGameTest extends GameTest {
    ...
    public void defineGame() {
        ...
        String pathGame =
                "/home/mirko/data/git/smartcampus.gamification/game-engine.games/pedibus-1exp";
        loadFilesystemRules(GAME, Arrays.asList(pathGame + "/constants",
                pathGame + "/ruleBadges.drl", pathGame + "/rulePoint.drl"));
    ...
    public void analyzeResult() {
        ...
        assertionBadge(GAME, Arrays.asList("Fai della Paganella"), "sinister six",
                "Meano-FliessItinerary");
    }
