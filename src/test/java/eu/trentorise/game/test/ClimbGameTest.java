...
public class ClimbGameTest extends GameTest {
    ...
    public void defineExecData(List<ExecData> execList) {
        ...
        // win first badge (Bolzano)
        payload = new HashMap<>();
        payload.put("meters-distance", 60000d);
        ...
        payload.put("school-date", "today");
        input = new ExecData(GAME_ID, "PlayerCalendarTrip", "alunno1", payload);
        execList.add(input);

        // gain next badges
        payload = new HashMap<>();
        payload.put("meters-distance", 250000d);
        input = new ExecData(GAME_ID, "PedibusKidTrip", "alunno1", payload);
        execList.add(input);

        // gain next badges
        payload = new HashMap<>();
        payload.put("meters-distance", 645000d);
        input = new ExecData(GAME_ID, "PedibusKidTrip", "alunno1", payload);
        execList.add(input);
