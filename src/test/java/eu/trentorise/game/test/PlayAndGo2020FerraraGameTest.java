...
public class PlayAndGo2020FerraraGameTest extends GameTest {
	...
	public void initEnv() {
		...
		assignment = new ChallengeAssignment();
		assignment.setModelName("multiTarget");
		assignment.setData(new HashMap<>());
		assignment.getData().put("bonusScore", 120.0);
		assignment.getData().put("bonusPointType", "green leaves");
		playerSrv.assignChallenge(GAME, "Colosso", assignment);
	}
	...
	public void defineGame() {
		...
		List<String> scoreNames = Arrays.asList("green leaves", "PandR_Trips", "Transit_Trips", "BikeSharing_Km",
				...
				"Carpooling_Km", "Carpooling_Trips", "Boat_Trips");
		...
		// survey challenge model
		ChallengeModel chain = new ChallengeModel();
		chain.setGameId(GAME);
		chain.setName("multiTarget");
		chain.getVariables().add("bonusScore");
		chain.getVariables().add("bonusPointType");
		gameSrv.saveChallengeModel(GAME, chain);
	}
	...
	public void defineExecData(List<ExecData> execList) {
		...
		data = new HashMap<String, Object>();
		data.put("trainDistance", 1.0);
		input = new ExecData(GAME, ACTION, "Colosso", data);
		execList.add(input);

		data = new HashMap<String, Object>();
		data.put("bikeDistance", 1.0);
		input = new ExecData(GAME, ACTION, "Colosso", data);
		execList.add(input);
	...
	public void analyzeResult() {
		...
		// test challenge chain
		assertionPoint(GAME, 120.0 + 2.0 + 6.0 + 6.0, "Colosso", "green leaves");
		assertionPoint(GAME, 2.0, "Colosso", "Bike_Trips");
		assertionPoint(GAME, 1.0, "Colosso", "Train_Trips");
